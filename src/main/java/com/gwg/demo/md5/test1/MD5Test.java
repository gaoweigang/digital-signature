...
/**
 * 批量生成sign
 * 技巧：负数在计算机中是用补码表示的，如果获得一个负数的补码呢？负1~负127的数加256获取该负数的补码,依次类推
 * -1：+256 -> 255 -> 0000 0000 1111 1111 -> 而负1的补码是 1111 1111
 * -127 ： +256 -> 129 ->  0000 0000 1000 0001 而负-127的补码是 1000 0001
 */
public class MD5Test {
    String str = "47f5ab8b2e97e18e4fb9e57718eb82af1000112018110917165307031541755370000";
        ...
        try {
            ...
            for (int offset = 0; offset < b.length; offset++) {
                ...
                if (i < 0){
                     ...
                     */
                    i += 256; //加256之后 就直接算出来byte负数的补码了，将补码存储在int中，可以理解为用int表示了byte补码,等价于i&0xff，与0xff进行位运算只会保留最低8位
                }
                //16进制用0~f表示0~15
